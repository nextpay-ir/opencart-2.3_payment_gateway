      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-nextpay" class="form-horizontal">
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-api">Api Key</label>
            <div class="col-sm-10">
              <input type="text" name="nextpay_api" value="<?php echo $nextpay_api; ?>" placeholder="Api Key" id="input-api" class="form-control" />
              <?php if ($error_api) { ?>
